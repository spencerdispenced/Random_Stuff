...
def valid_matrix(matrix: list[list[int]]) -> bool:
    ...
    # for x in matrix + list(zip(*matrix)):
    #     if set(x) != nums:
    #         return False
...
if __name__ == '__main__':
    ...
    matrix1 = [[1, 2, 3], [3, 1, 2], [2, 3, 1]]  # True
    print(valid_matrix(matrix1))

    matrix2 = [[1, 1, 1], [1, 2, 3], [1, 2, 3]]  # False
    print(valid_matrix(matrix2))
    ...
    print(valid_matrix(matrix3))  # False
